...
const CompilingSmartContractDemo: React.FC = () => {
  ...
  const [compileResult_bytecode, setCompileResult_bytecode] = useState<string>('');
    ...
    <div>
      ...
      >
          ...
          <div>
            ...
            <Collapse in={deploy_open && deploySuccess && !deploying}>
              <Alert
                ...
                sx={{ mb: 2 }}
              >
                <Text>✅ - Check your transaction on <a target="_blank" href={message}>Etherscan</a></Text>
              </Alert>
              <h4 />
            </Collapse>
            <Collapse in={deploy_open && !deploySuccess && !deploying}>
        ...
        <div>
          ...
          <h3 />
          <Text variant="uppercase">Code Was Compiled By Latest Solidity Compiler</Text>
